  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      const productoEnviar = {
        ...producto,
        price: producto.price.toString().replace(',', '.')
      };
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <input
          ...
          style={{
            width: '100%',
            padding: '8px',
            border: `1px solid ${errores.title ? 'red' : '#ccc'}`,
            borderRadius: '4px'
          }}
          placeholder="Ingrese el nombre del producto"
        />
        {errores.title && <p style={{ color: 'red', margin: '5px 0', fontSize: '14px' }}>{errores.title}</p>}
      </div>
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <input
          ...
          style={{
            width: '100%',
            padding: '8px',
            border: `1px solid ${errores.price ? 'red' : '#ccc'}`,
            borderRadius: '4px'
          }}
        />
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <textarea
          ...
          style={{
            width: '100%',
            padding: '8px',
            border: `1px solid ${errores.description ? 'red' : '#ccc'}`,
            borderRadius: '4px',
            resize: 'vertical'
          }}
        />
        <div style={{
          fontSize: '12px',
          color: producto.description.length > 200 ? 'red' : '#666',
          marginTop: '5px'
        }}>
          {producto.description.length}/200 caracteres
        </div>
        {errores.description && (
          <p style={{ color: 'red', margin: '5px 0', fontSize: '14px' }}>{errores.description}</p>
        )}
      </div>
